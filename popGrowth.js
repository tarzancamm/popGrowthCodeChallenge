...
const nbYear = (startPop, percent, newRes, totalFuture) => {
    let newPopulation = startPop
    let numYears = 0
    while (newPopulation < totalFuture) {
        newPopulation += (newPopulation * (percent / 100)) + newRes
        numYears++
    }
    return numYears
}
...
// starting pop, percent change/yr, num of new residents moving in, total future pop